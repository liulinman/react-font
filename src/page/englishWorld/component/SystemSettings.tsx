...
export const getSystemSettings = async (): Promise<SystemSettings> => {
  ...
  try {
    ...
    if (reciteConfig && reciteConfig.configValue) {
      const value = reciteConfig.configValue;
      settings.wordDictation = {
        dictationCount:
          value.wordCount || DEFAULT_SETTINGS.wordDictation.dictationCount,
    ...
    if (listeningConfig && listeningConfig.configValue) {
      const value = listeningConfig.configValue;
      settings.wordListening = {
        dictationCount:
          value.wordCount || DEFAULT_SETTINGS.wordListening.dictationCount,
        proficiencyLevels: Array.isArray(value.proficiencyLevels)
          ? value.proficiencyLevels
          : value.proficiencyLevel
          ? [value.proficiencyLevel]
